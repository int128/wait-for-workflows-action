...
It deduplicates the workflow runs by the workflow name and event name.
If there are multiple workflow runs of the same name and event, it waits for the latest one.
